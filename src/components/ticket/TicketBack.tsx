...
export const TicketBack: React.FC<TicketBackProps> = ({ data, isPreview = false }) => {
  ...
  return (
    ...
    >
      <div 
        className="absolute inset-0 p-4 text-white font-[SimSun]"
        style={{ opacity: 1 }}
      >
       <div className="">
            <span className="font-bold text-xl" style={{ letterSpacing: '-2px'}}>{data.backTitle}</span>
